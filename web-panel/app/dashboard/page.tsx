...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold text-foreground mb-2">{tCommon('welcomeBack')}</h2>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{tCommon('recipes')}</p>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{tCommon('accessKeys')}</p>

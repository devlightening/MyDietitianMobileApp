...
export default function ClientDetailPage() {
  ...
  const insights = useMemo(() => {
    ...
    if (weeklyData.average < 50) {
      insightsList.push({
        ...
        message: `Average compliance is ${weeklyData.average.toFixed(0)}%. Client may need additional support.`,
      });
    }
    ...
    if (weeklyData.trend === 'down') {
      insightsList.push({
        ...
        message: 'Compliance has been decreasing over the last few days. Consider checking in with the client.',
      });
    } else if (weeklyData.trend === 'up') {
      insightsList.push({
        type: 'positive',
        title: 'Improving Trend',
        message: 'Compliance is trending upward. Great progress!',
      });
    }
    ...
    if (data?.meals) {
      ...
      if (skippedBreakfasts > 0) {
        insightsList.push({
          type: 'info',
          title: 'Breakfast Compliance',
          message: `${skippedBreakfasts} mandatory breakfast item(s) skipped today.`,
        });
      }
    }
      ...
      <div className="space-y-8">
        ...
        <Card className="p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">Failed to load client data</h3>
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Meal Timeline */}
      <div>
        <h2 className="text-lg font-semibold text-foreground mb-4">Daily Timeline</h2>
